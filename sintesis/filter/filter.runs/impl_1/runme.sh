...
HD_PWD='E:/Especializacion_fiuba/CLP/trabajo final/FIR/sintesis/filter/filter.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log filter_VIO.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source filter_VIO.tcl -notrace
