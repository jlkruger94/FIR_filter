...
HD_PWD='E:/Especializacion_fiuba/CLP/trabajo final/FIR/sintesis/filter/filter.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log filter_VIO.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source filter_VIO.tcl
